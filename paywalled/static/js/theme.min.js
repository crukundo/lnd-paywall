...
var Theme = function () {
        function t() {
            ...
            _classCallCheck(this, t), this.colors = {
                ...
                white: "#ffffff"
            }, this.skins = ["default", "dark"], this.skin = localStorage.getItem("skin") || "default", this.hasCompactMenu = JSON.parse(localStorage.getItem("hasCompactMenu")) || !1, this.autoInit = localStorage.getItem("autoInit") || !0, $(document).ready(function () {
                e.autoInit && e.init()
            })
        }
        ...
        return _createClass(t, [{
            ...
            value: function () {
                $('.dropdown-menu [data-toggle="dropdown"]').on("click", function (e) {
                    ...
                    var t = $(this),
                        a = t.parent(),
                        i = t.next();
                    a.siblings().find(".dropdown-menu").removeClass("show"), i.toggleClass("show"), t.parents(".nav-item").on("hidden.bs.dropdown", function () {
            ...
            value: function () {
                var e;
                window.StackedMenu && this.isExists("#stacked-menu") && (this.stackedMenu = new StackedMenu(this.getMenuOptions()), $(".app").toggleClass("has-compact-menu", this.hasCompactMenu), this.watchAside(), $(this.stackedMenu.selector).on("menu:open menu:close", function () {
                    setTimeout(function () {
            ...
            value: function () {
                var e = $(".app");
                void 0 !== this.stackedMenu && (!this.isToggleScreenUp() || e.hasClass("has-fullwidth") ? (this.stackedMenu.compact(!1).hoverable(!1), e.removeClass("has-compact-menu")) : (this.stackedMenu.compact(this.hasCompactMenu).hoverable(this.hasCompactMenu), e.toggleClass("has-compact-menu", this.hasCompactMenu)))
            }
        }, {
            key: "handleAsideMenu",
            value: function () {
            ...
            key: "bootstrapSelect",
            value: function () {
                $.fn.selectpicker && ($.fn.selectpicker.Constructor.DEFAULTS.style = "", $.fn.selectpicker.Constructor.DEFAULTS.styleBase = "custom-select", $.fn.selectpicker.Constructor.DEFAULTS.iconBase = "mr-1 fa", $.fn.selectpicker.Constructor.DEFAULTS.tickIcon = "fa-check font-size-sm mt-2", $('[data-toggle="selectpicker"]').each(function () {
            ...
            value: function () {
                ...
                $(window).on("resize", function () {
                    e.isToggleScreenUp() && $(".app-aside").hasClass("has-open") && !$(".app").hasClass("has-fullwidth") && e.hideAside(), e.watchAside(), $(".app-aside, .page-sidebar").addClass("notransition"), setTimeout(function () {
